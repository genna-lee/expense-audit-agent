...
DEMO_ENTRIES = [
    ...
    make_entry("EXP-202606-0015", "張三豐", 90000, "電腦採購",
               ...
               fraud_flags=[
                   ...
                   "各筆未達門檻（NT$ 150,000），加總 NT$ 270,000 >= NT$ 150,000"
               ],
    ...
    make_entry("EXP-202606-0017", "孫曉燕", 75000, "器材採購",
               ...
               fraud_flags=[
                   ...
                   "各筆未達門檻（NT$ 150,000），加總 NT$ 155,000 >= NT$ 150,000"
               ],
    ...
    # ── 出差浮報（2 筆，REJECTED）────────────────────────
    make_entry("EXP-202606-0018", "陳美美", 26000, "出差旅費",
               "2026-06-13", "前往台北參加學術研討會",
               "REJECTED",
               fraud_flags=[
                   "出差天數浮報: 申報 5 天，實際行程 3 天",
                   "住宿費超上限: 每晚 NT$ 5,000，上限 NT$ 4,500",
                   "雜費超上限: 每日 NT$ 800，上限 NT$ 400",
               ],
               risk_level="HIGH",
               timestamp="2026-06-13T16:00:00Z"),
    make_entry("EXP-202606-0019", "方志強", 19000, "出差旅費",
               "2026-06-27", "前往高雄出差三天",
               "REJECTED",
               fraud_flags=[
                   "住宿費超上限: 每晚 NT$ 4,800，上限 NT$ 4,500",
               ],
               risk_level="HIGH",
    ...
    make_entry("EXP-202606-0021", "鄭雅文", 350000, "業務費",
               ...
               "REJECTED",
               fraud_flags=["業務費超上限: 類別「業務費」上限 NT$ 200,000，申報 NT$ 350,000"],
               risk_level="HIGH",
